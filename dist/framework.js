...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"between\": () => (/* binding */ between),\n/* harmony export */   \"getIndexesOf\": () => (/* binding */ getIndexesOf),\n/* harmony export */   \"letterToUpperCaseAt\": () => (/* binding */ letterToUpperCaseAt)\n/* harmony export */ });\nconst between = (x, min, max) => {\r\n    return x >= min && x <= max;\r\n}\r\n\r\nconst letterToUpperCaseAt = (str, index) => {\r\n    return str.substr(0, index) + str.charAt(index).toUpperCase() + str.substr(index + 1);\r\n}\r\n\r\nconst getIndexesOf = (str, searchElement) => {\r\n    var a = [], i = -1;\r\n\r\n    while ((i = str.indexOf(searchElement, i + 1)) >= 0) {\r\n        a.push(i);\r\n    }\r\n\r\n    return a;\r\n}\n\n//# sourceURL=webpack://tw-framework/./src/utils.js?");
